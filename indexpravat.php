  ...
  <section id="content-wrap"> 
    ...
    <article class="banner-block">
      ...
      <div class="box-row">
        ...
        <div class="button_position">
          <div class="create-app-button"> <a href="themes" title="Create your app">Create your app</a> </div>
          <div class="clear"></div>
    ...
    <article class="pick-app-block">
      <div class="box-row">
        ...
        <div class="library-button"> <a href="themes" title="">Go to library</a> </div>
      </div>
    </article>
    <!-- end pick app block --> 
    ...
    <article  class="box-row">
      <div class="profess-app">
        ...
        <div class="profess-app-text">
          ...
          <a href="themes">Create App</a> 
<a href="content-apps">Learn more</a>
