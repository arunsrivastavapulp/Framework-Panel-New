...
";
    ...
    foreach ($result_eventAll as $resultAllEventSet) {
        ...
        $arraycomp_elements["image"] = array("media_type" => 'image', "image_url" => 'http://www.instappy.com/images/search.jpg', "height" => '24', "width" => '24');
...
function searchData() {
    ...
    if ($authResult == 0 || $device_id == '') {
        ...
        if ($primaryapp_type == "1" && isset($_POST['primary_app_id'])) {
            $priarray = contentapp_search($primaryapp_id, $searchItem, $offset,$limit);
            //  $filterarr=[];
        }
        ...
        ////Primary Retails App Code Start////
            ...
            $priarrayval = retailapp_search($primaryapp_id, $searchItem, $offset, $sortorder, $orderby,$limit);
        ...
        if (isset($_POST['secondary_app_id']) && isset($_POST['secondary_app_type']) && $_POST['secondary_app_id'] != '') {
            ...
            if ($secondaryapp_type == "1") {
                //            echo "SECOND APP";
                $secarray = contentapp_search($secondaryapp_id, $searchItem, $offset,$limit);
                //
            }
            ////Primary Content App Code End////
            ////Primary Retails App Code Start////
                ...
                //   echo "SECOND APP";
                $secarrayval = retailapp_search($secondaryapp_id, $searchItem, $offset, $sortorder, $orderby,$limit);
