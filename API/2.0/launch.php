...
function launch() {
    ...
    if ($app_type != '1') {
        $navcatarray[] = array("name" => "Home", "icon" => "e605", "is_child" => "0", "level" => "0", "link_to_screenid" => "-1", "catalogue_component" => array("screen_type" => "1", "category_id" => "", "app_type" => "$app_type", "catalogue_app_id" => "$app_idString"), "cat_array" => $childValues);
    }
    ...
    $restnavVal = getnavigationValue(null, $contentAppId);
