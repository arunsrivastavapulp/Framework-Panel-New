...
<table cellpadding="0" cellspacing="0" width="650" align="center" style="border:1px solid #7c7c7c;">
    <tr bgcolor="#ffffff" >
    	<td  style="padding:15px 0 10px 0px;">
        	<table cellpadding="0" cellspacing="0" width="610" align="center" bgcolor="#ffffff">
            	<tr>
                	<td align="left">
	...
	<tr>
    	<td>
        	<img src="{base_url}edm/images/Registration-top.png" style="display:block"/>
        </td>
    </tr>
    <tr>
    	<td>
        	<table cellpadding="0" cellspacing="0" width="577" align="center" >
            	<tr>
                	<td style="width: 444px;padding-right: 20px;box-sizing: border-box;">
						...
						<p style="margin:0;color:#8b8b8a; margin:0;padding:0; font-size:16px; line-height:20px;font-family:Arial, Helvetica, sans-serif;">Hi,</p><br/>
						
						<p style="margin:0;color:#8b8b8a; margin:0;padding:0; font-size:16px; line-height:28px;font-family:Arial, Helvetica, sans-serif;">
							Before we go ahead, we would like to verify your email for security purposes. Please click on the link below to verify your email and log in to your Instappy account: 
						</p>
						<p style="margin:0;color:#8b8b8a; margin:0;padding:0; font-size:16px; line-height:25px;font-family:Arial, Helvetica, sans-serif;">&nbsp;</p>

						<p style="margin:0;color:#ffcd01; margin:0;padding:0; font-size:20px; line-height:30px;font-family:Arial, Helvetica, sans-serif;font-weight:bold;"> 			
							<a href="{verify_link}" target="_blank"><img src="{base_url}edm/images/verify-link.png" style="border:none" /></a>
						</p>
						...
						<p style="margin:0;color:#8b8b8a; margin:0;padding:0; font-size:16px; line-height:28px;font-family:Arial, Helvetica, sans-serif;">
							If you are having difficulties accessing the link, you can copy and paste the link below into a new tab on your browser:
						</p>
						<p style="margin:0;color:#ffcd01; margin:0;padding:0; font-size:16px; line-height:28px;font-family:Arial, Helvetica, sans-serif;"> 			
							{verify_link}
						</p>
                    ...
                    <td style="padding:0; margin:0;" valign="top">
                    	<img src="{base_url}edm/images/Registration-mobile.png" style="margin:"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <p style="margin:0;color:#8b8b8a; margin:0;padding:0; font-size:16px; line-height:28px;font-family:Arial, Helvetica, sans-serif;">
                           Wishing you great App-ing experience with Instappy. 
                        </p>
                        
                            
                        <p style="margin:0;color:#8b8b8a; margin:0;padding:0; font-size:14px; line-height:30px;font-family:Arial, Helvetica, sans-serif;">&nbsp;</p>
