...
<link href="css/nav-custom-style.css?r=4" rel="stylesheet">
...
/*    .modal-footer{padding:15px;text-align:right;border-top:1px solid #e5e5e5}*/
    ...
    .container.droparea{background-size:cover; background-repeat: no-repeat;background-position: top center}
    .change-popup-size { height: 450px !important;
    width: 300px !important;
    margin-top: -220px !important;
    margin-left: -150px !important;
    display: block; transform: scale(2); -webkit-transform: scale(2); -ms-transform: scale(2); -moz-transform: scale(2); -o-transform: scale(2); }
    .change-popup-size input { width: 100% !important; }
    .change-popup-size .login_popup_body { max-height: 75%; overflow-y: auto; }
...
<script type="text/javascript">
    ...
    var param = {'appidQR': response2, 'platform': '3'};
    var form_data = {
														data: param, //your data being sent with ajax
...
//                print_r($apppage);
        ...
        <div class="addPage"><a href="javascript:void(0);" style="color:#fff;" ia-track="IA10100035">Add New Screen</a></div>
        <ul class="top-aside">
            ...
            <?php } ?>
            <li class="save"><a href="#" id="savehtml" ia-track="IA10100036">Save <i class="fa fa-cloud-upload"></i></a></li>
            <li><a href="javascript:void(0)" id="finish" ia-track="IA10100037"><?php echo $buttonCreate; ?> <i class="fa fa-sign-in"></i></a></li>
        </ul>
    </header>
                ...
                <div class="mid_section_right">
                    ...
                    <div class="mid_right_box active">
                        ...
                        <div class="mid_right_box_body">
                            ...
                            <a href="javascript:void(0)" class="make_app_next2 saveAndcontinue" ia-track="IA10100036">Save & Continue</a>
                            <div class="clear"></div>
                        </div>
                    </div>
                    ...
                    <div class="mid_right_box">
                        <div class="mid_right_box_head ">
                            <h1 class="appDetailsave">Customize Your App Properties and Navigation Menu<h2 class="savingDetails">Saving...</h2><h2 class="savedDetails">All changes have been saved.</h2></h1>
                            <h2>Wow! Looks like you got to the fun part. This is where you can start to customise your app. Start with changing the background colour of your app, colour of the title bar, choose to add login and contact us screen, and lots more. Remember soft pastels enhance great pictures, so your app background should ideally be a pastel.  You can also try multiple combinations before you finalise. So go ahead and experiment. </h2>
                        ...
                        <div class="mid_right_box_body GeneralDetails">
                            ...
                            <div class="design_menu_box Page">  
                              ...
                              <div class="backgroundImage">
                               ...
                               <div class="clear"></div>
                                ...
                                <div class="clear"></div>
                                <div class="app_change_image selectImage">
                                    <input type="file" id="screen-bg">
                                    <img src="<?php  echo $basicUrl; ?>images/browse_bg.jpg" class="editbrowse2" alt="Image Not Found">
                            ...
                            <div class="design_menu_box navItemEdit">
                                <h2>Navigation Menu</h2>
                                 <h3>Create your custom menu!! You can now put screens under categories to further customize and shorten navigation menu OR add up-to 10 screens in menu. Let the navigation now be crisp and short just as required.</h3>
                            <a class="read_more">Read More...</a>
                                <div class="menu_links">
                                    ...
                                    <ul class="menu_body_links nav_items_edit" data-ind="1">
                                        ...
                                        <li class="navText">
											<div class="selectContainer clearfix" id="container_1" container-ind="1">
												<select class="navCategoryList" style='width:49%;float:left;'>
													<option value="Choose Screen">Choose Screen</option>
												</select>
												<input type='text' value='' class='nav-cat_name' placeholder='Enter Catagory Name' maxlength='15' style='width:49%;float:right;display:none'>  
												<div class="clearfix"></div>
											</div>
                                        </li> 
										<li class="viewdelete"><input type="button" value="View &amp; Edit" class="viewScreen"></li>
										<li class="viewdelete"><i class="fa fa-trash deleteSlide"></i></li>
                                    </ul>
                                </div>
                                <div class="" style="display:none">
                                    <select class="navSubCategoryList"> 
                                ...
                                <!-- div class="feedback">
                                    <ul>
                                        ...
                                        <li class="two_text"><input type="text" value="Feedback" disabled="disabled" /><input type="text" placeholder="Email Id" class="feedbackEmail"/></li>
                                        <li class="view_feedback"><button class="feed-up"><i class="fa fa-eye fa-lg"></i></button></li>
                                        <li></li>
                                    </ul>
                                </div -->
                            ...
                            <form id="uploadForm"  method="post" enctype="multipart/form-data">
                                <div class="design_menu_box createLogin">
                                    ...
                                    <label for="createLoginInput" class="createLoginLabel">Add Login Screen To Your App</label>
...
<?php $loginData = explode(',', $signData['app_signupsource_id']); ?>
                                    ...
                                    <div class="content_textbox upload_img">
                                        ...
                                        <div class="login_options">
                                            ...
                                            <div class="fb_create_login_box" <?php if($signData['fb_id']!=''){echo "style='height: 61px;'";} ?>>
...
?> >
                            ...
                            <div class="design_menu_box">
                                <div class="catalogue_add_feature contactus">
                                    <div class="catalogue_input_group">
                                        ...
                                        <label for="contact">Add Contact Us Screen</label>
                                        <div class="clear"></div>
                                        <!-- a href="#">Preview</a -->
                                    </div>
                                    <div class="catalogue_detail_input">
                                        <ul>
                                            ...
                                            <?php
                                             if(isset($appname['contactus_email']))
                                             {
                                                 if($appname['contactus_email'] != 'undefined')
                                                 { 
                                            $contactEmail= $appname['contactus_email'];
                                                 }
                                                 else
                                                 {
                                                    $contactEmail='';    
                                             ...
                                             if(isset($appname['contactus_phone']))
                                             {
                                                 if($appname['contactus_phone'] != 'undefined')
                                                 { 
                                            $contactMobile= $appname['contactus_phone'];
                                                 }
                                                 else
                                                 {
                                                    $contactMobile='';    
                                            ...
                                            ?>
                                            <li><input type="text" placeholder="Enter email id" class='contactusEmail'  maxlength="100" name="contactus_email" value="<?php echo $contactEmail; ?>"><!-- em>@</em><input type="text" placeholder="domainname.com" / --><div class="clear"></div><span>Enter email id to where you want your users to contact you for help.</span></li>
                                    ...
                                    <div class="catalogue_detail_input">
                                        <ul>
                                            ...
                                            <li><input type="text" placeholder="Enter phone number" class="contactusNo" maxlength="16" minLength="5" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" name="contactus_no" value="<?php echo $contactMobile ?>">
                            ...
                            <a href="javascript:void(0)"  ia-track="IA10100051" id="save" class="make_app_next2 saveAndcontinue">Save & Continue</a>
                            ...
                            <div class="mid_right_box_body">
                                <div class="design_menu_box">
                                    ...
                                    <div class="add_page_themes">
                                        ...
                                        <div class="new_theme" data-layout="22">
                                            <img src="<?php echo $basicUrl; ?>images/add_theme22.png" alt="Theme 22">
                                        </div>
                                        <div class="new_theme" data-layout="15">
                                            <img src="<?php echo $basicUrl; ?>images/add_theme15-new.png" alt="Theme 15">
                                        </div>
                                       <div class="new_theme" data-layout="23">
                                            <img src="<?php echo $basicUrl; ?>images/add_theme23.png" alt="Theme 23">
                                        </div>
                                     <!--   <div class="new_theme" data-layout="26">
                                            <img src="<?php // echo $basicUrl; ?>images/add_theme24.jpg" alt="Theme 26">
                                        </div>
                                        <div class="new_theme" data-layout="27">
                                            <img src="<?php // echo $basicUrl; ?>images/add_theme24.jpg" alt="Theme 27">
                                        </div>
                                        <div class="new_theme" data-layout="28">
                                            <img src="<?php // echo $basicUrl; ?>images/collage.jpg" alt="Theme 28">
                                        </div> -->
                                        <div class="new_theme" data-layout="20">
                                            <img src="<?php echo $basicUrl; ?>images/add_theme20.png" alt="Theme 20">
                                      </div>
                                        <div class="clear"></div>
                                    </div>
                    ...
                    <div class="mid_right_box">
                        <div class="mid_right_box_head ">
                            <h1 class="appDetailsave">Add E-Store to your App</h1>
                        ...
                        <div class="mid_right_box_body GeneralDetails">
                          <div class="design_menu_box createLogin">
                                ...
                                <label for="addStore" class="createLoginLabel">E-Store</label>
...
<?php } ?>
                                    ...
                                    <span>OR</span>
                                    <a href="<?php echo $siteURL; ?>themes.php#/?q=30" ia-track="IA1010007">Create New</a>
                                </div>
                                <div class="clear"></div>
                            </div>

                            <a href="javascript:void(0)" id="save" class="make_app_next2 saveAndcontinue" ia-track="IA10100036">Save & Continue</a>
                            <div class="addPage" ia-track="IA10100035">Add New Screen</div>
                        ...
                        <div class="mid_right_box_body">
                            <div class="utility_api_cards">
                                <div class="utility_api_content clones container">
                                    ...
                                    <!-- Image on text Component 58 23-5-16 start-->
                                      <div class="full_widget change_text_option layout1 layout8" data-component="58" data-ss-colspan="2">
                                        <p class="widgetClose">x</p>
                                  ...
                                  <!-- ariba Component 59 16-6-16 start-->
                                    ...
                                    <div class="glry_widget change_text_option layout26 ss-active-child ui-draggable" data-component="1" style="display: block; left: 0px; top: 10px;">
                                        <p class="widgetClose" style="display: block;">x</p><div class="half_widget_img"><img src="<?php echo $basicUrl; ?>images/glry.jpg" alt="Image Not Found" class="mCS_img_loaded"><img src="<?php echo $basicUrl; ?>images/video_img_half.png" alt="" class="video_img lazy mCS_img_loaded"><div class="clear"></div></div>

                                    </div>
                                    <div class="glry_ract_widget change_text_option layout27 ss-active-child ui-draggable" data-component="1" style="display: block; left: 0px; top: 10px;">
                                        <p class="widgetClose" style="display: block;">x</p><div class="half_widget_img"><img src="<?php echo $basicUrl; ?>images/gallery_ract.jpg" alt="Image Not Found" class="mCS_img_loaded"><img src="<?php echo $basicUrl; ?>images/video_img_half.png" alt="" class="video_img lazy mCS_img_loaded"><div class="clear"></div></div>
                                    ...
                                    <div class="full_widget head_cont layout1 layout11" data-ss-colspan="2" data-component="19">
                                        <p class="widgetClose">x</p>
                                        <div class="full_widget_img">
                                            <img src="<?php echo $basicUrl; ?>images/widget_full_img.jpg" alt="Image Not Found" >
                                    ...
                                    <div class="full_widget long_text layout1 layout6" data-ss-colspan="2" data-component="13">
                                        <p class="widgetClose">x</p>
                                        <div class="full_widget_img">
                                     ...
                                     <div class="full_widget long_text layout1 layout6 with-out-share" data-ss-colspan="2" data-component="13">
                                        <p class="widgetClose">x</p>
                                        <div class="full_widget_img">
                                    ...
                                    <div class="item_full_widget layout1 layout12" data-ss-colspan="2" data-component="9">
                                        <p class="widgetClose">x</p>
...
-->
                                 ...
                                 <div class="full_textbox_date common_form_box layout21" data-ss-colspan="2" data-component="50">
                                   ...
                                   <div class="full_textbox_time common_form_box layout21" data-ss-colspan="2" data-component="50">
                                    ...
                                    <div class="full_attachment_box common_form_box layout21" data-ss-colspan="2" data-component="56">
                                        <p class="widgetClose">x</p>
                                        <div class="full_textbox_inner">
                                            <div class="upload-label">
                                                <label class="common_input_label">Label Text</label>
                                            </div>
                                            <input id="uploadFile" class="select-file" placeholder="Choose File" disabled="disabled" />
                                            <div class="fileUpload"> <span>Browse</span>
                                                <input id="uploadBtn" type="file" class="upload" />
                                            </div>
                                            <p class="file-hint">Please upload Document (.pdf, .doc, .xlsx) file. <sub>(Maximum file size allowed is 2MB)</sub></p>
                                        </div>
                                        <div class="common_input_overlay"></div>
                                    </div>
                                    <!-- form cards ends -->
                                  ...
                                  <!--business screen start-->
                                    <div class="business-card business-card-name layout22" data-ss-colspan="2" data-component="60">
                                      <p class="widgetClose">x</p>
                                      <div class="business-contantarea"><span><img src="<?php echo $basicUrl; ?>images/user-1.png" alt="name"></span>
                                        <p>Name</p>
                                      </div>
                                    </div>
                                    
                                  <div class="business-card business-card-phone layout22" data-ss-colspan="2" data-component="60">
                                      <p class="widgetClose">x</p>
                                      <div class="business-contantarea"><span><img src="<?php echo $basicUrl; ?>images/phone-handset.png" alt="Phone"></span>
                                      <p>Phone</p>
                                      </div>
                                    </div>
                                    <div class="business-card business-card-email layout22" data-ss-colspan="2" data-component="60">
                                      <p class="widgetClose">x</p>
                                      <div class="business-contantarea"><span><img src="<?php echo $basicUrl; ?>images/envelope.png" alt="name"></span>
                                      <p>Email</p>
                                      </div>
                                    </div>
                                    <div class="business-card business-card-note layout22" data-ss-colspan="2" data-component="60">
                                      <p class="widgetClose">x</p>
                                      <div class="business-contantarea"><span><img src="<?php echo $basicUrl; ?>images/notes24.png" alt="name"></span>
                                            <p class="note-text">Note</p>
                                      </div>
                                    </div>
                                    <div class="business-card business-card-address layout22" data-ss-colspan="2" data-component="60">
                                      <p class="widgetClose">x</p>
                                      <div class="business-contantarea"><span><img src="<?php echo $basicUrl; ?>images/map-marker.png" alt="name"></span>
                                      <p class="note-text">Address</p>
                                      </div>
                                    </div>
                                    <div class="business-card business-card-map layout22" data-ss-colspan="2" data-component="62" business-longitude="0" business-latitude="0">
                                      <p class="widgetClose">x</p>
                                      <div class="mapview">
                                      <p>Map View</p>
                                      </div>
                                  ...
                                  <!--Grid screen start-->
                                    <div class="half_widget round_widget layout15" data-component="61" >
                                      ...
                                      <div class="widget_inner">
                                        <div class="round_widget_imgbox"><img src="<?php echo $basicUrl; ?>images/grid-circle1.png">
                                          <div class="clear"></div>
                                        </div>
                            ...
                            <div class="utility_api_cards">
                                ...
                                <div class="utility_api_content clones container">
																	...
																	<!--Audio Card start-->
																	<!-- <div class="audio layout1 ss-active-child ui-draggable" data-ss-colspan="2" data-component="22" style="display: block; left: 0px; top: 10px;">

                                        <p class="widgetClose" style="display: block;">x</p>

                                        <span>Play Audio</span>

                                        <img class="pus mCS_img_loaded" src="images/pus.png" alt="Pause">
                                        <img class="bar mCS_img_loaded" src="images/bar.jpg" alt="Pause"> 
																	...
																	<!--Audio Card start-->
																	<div class="audio audio2 layout1" data-ss-colspan='2' data-component="22">
																		<p class="widgetClose">x</p>
																		<div class="img_side">
																			<img src="<?php echo $basicUrl; ?>images/au.png" alt="Album" class="mCS_img_loaded">
																			<!--<img src="images/albume.jpg" alt="Album">-->
																		</div>
																		<div class="heading_side">
																			<h2 class="heading">Name of the audio</h2>
																			<span class="sub-heading">Name of the album</span>
																			<br>
																			<div class="start_time">02.35</div>
																			<div class="end_time">02.35</div>
																		</div>
																		<!--<span>Play Audio</span>
...
<div class="clear"></div>
                            ...
                            <div class="addPage" style="margin-right:0px;" ia-track="IA10100035">Add New Screen</div>
                            <div class="clear"></div>
                        </div>
                    </div>
                        ...
                        <div class="mid_right_box_body">
                            <div class="design_menu_box screenDetails">
                                <div class="screen_details">
                                    <h3>Screen Details <i class="fa fa-trash deleteSlide"></i></h3>
                            ...
                            <div class="design_menu_box  glryItemEdit">
                                ...
                                <div class="clear"></div>
                                <a href="javascript:void(0)" class="addGlry">AddImage</a>
                            </div>
                            <!-- even cricle start-->
<div class="design_menu_box circle-event">
<h2>Choose Card Image</h2>
<p>Choose a card image (preferable size is <span>2 MB</span> or less)</p>
<div class="change_image">
<input type="file" id="editbrowse_img otherimgs">
<img src="<?php echo $basicUrl; ?>images/browse_full_img.jpg" class="editbrowse event-cricle-image" alt="Image Not Found">
<!-- <span>Image</span> -->
</div>
<div class="clear"></div>
</div>
<!-- even cricle start-->
                          ...
                          <!--circle theme end-->
                            ...
                            <div class="design_menu_box widgetEdit mapwidgetEdit">
                                ...
                                <div class="content_textbox subHeadingOption">
                                 ...
                                 <div class="clear"></div>
                                 <div class="expirecard">

                                <div class="catalogue_add_feature expiry">
                                    <div class="catalogue_input_group">
                                    ...
                                    <div class="catalogue_detail_input">
                                        <ul>
                                            <li class="setexpiry"><label>Expiry Date:</label></li>
                                            <li><input type="text" class="eventDate expireit" style="width:50%"><em>This will allow to set an expiry date for this content. If you want to keep the content forever you can skip this field.</em></li>
                                            <div class="clear"></div>
                                        </ul>
                                    </div>
                                </div>
                          ...
                          <div class="design_menu_box business-card-edit">
                               ...
                               <div class="content_textbox business-name-box">
                                ...
                                <div class="content_textbox business-phone-box">
                                    <input type="tel" class="business-phone" maxlength="10" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
                               ...
                               <div class="clear"></div>
                                ...
                                <div class="content_textbox business-email-box">
                                    <input type="email" class="business-email" maxlength="35">
                                    <em>Maximum of 35 Characters</em>
                                </div>
                               <div class="clear"></div>
                                ...
                                <div class="content_textbox business-note-box">                                    
                                    <input type="text" name="note" class="business-note" maxlength="70">
                                    <em>Maximum of 70 Characters</em>
                                </div>
                               <div class="clear"></div>
                                ...
                                <div class="content_textbox business-addres-box">
                                    <input type="text" class="business-addres" maxlength="70">
                                    <em>Maximum of 70 Characters</em>
                                </div>
                                <div class="clear"></div>
                              <!--  <div class="content_label business-icon-bg">
                                  <label>Background Color Change:</label>
                           </div>
                                <div class="content_textbox business-icon-bg">
                                  <span class="editPicker31"></span>
                                </div> -->
                            </div>
                          ...
                          <!-- social crd's heading and sub-heading option end-->
                            ...
                            <div class="design_menu_box festivalList">
							   ...
							   <span class="eventcomp6">
                                ...
                                <a class="make_app_next addList" style="margin-right:15px;" href="#">Add/View Event</a>
                                 <div class="clear"></div>
                                 <div class="expirecard">
                          ...
                          <!-- 28-6-16 end-->
                            ...
                            <div class="design_menu_box audioWidget">
                                ...
                                <div class="content_textbox">
                                    <input type="text" class="audioSubHead" maxlength="20">
                                    <em>Maximum of 20 Characters</em>
                                </div>-->
...
<input type="text" class="weblink_textbox_edit">
    ...
    <div class="design_menu_box qr-show"><h2>Add QR code scanner to your app</h2>
<p class="common_change_card">Use this screen to scan any QR code from your app and do the action defined in QR code.</p></div>                      
                         <!--Zopim start-->
<div class="design_menu_box zopimEdit">
<h2>Support Chat Screen (Zopim)</h2>
<h3>With Zopim Live Chat, visitors to your app will be able to chat directly with you through the widget given in the app and you can manage multiple conversations through the online Dashboard. Login with Zopim now and give us your account key to provide chat support in your app. Find out more at <a href="https://www.zopim.com/" target="_blank">https://www.zopim.com/</a></h3><a class="read_more">Read More...</a>
...
<div class="content_textbox">
<input type="text" class="zoopim_account_key" required>
<!--<em>Maximum of 15 Characters.</em>-->
</div>
<!--<div class="content_label">
...
<div class="content_textbox">
<input type="text" class="zoopim_visitor_name" maxlength="20" required>
<em>Maximum of 20 Characters.</em>
</div>
<div class="content_label">
<label>Mobile</label>
...
<div class="content_textbox">
<input type="text" class="zoopim_visitor_mobile" maxlength="15" minlength="5" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
<em>Maximum of 15 Characters.</em>
</div>
<div class="content_label">
<label>E-mail</label>
...
<div class="content_textbox">
<input type="text" class="zoopim_visitor_email" maxlength="40">
<em>Maximum of 40 Characters.</em>
</div>
<div class="content_label">
<label>Welcome Message</label>
</div>
<div class="content_textbox">
<textarea class="big_text_head7 notEdit" id="zoopim_welcome" maxlength="200"></textarea>
<em>Maximum of 200 Characters.</em>
</div>-->
...
<!--Zopim end-->
                            ...
                            <div class="design_menu_box videoEdit">
                                ...
                                <div class="content_textbox">
                                    <input type="text" placeholder="Enter Video Name" maxlength="20" class="video_name">
                                </div>
                            ...
                            <div class="design_menu_box widgetLinkEdit">
                                <div class="addPage Widget">Add New Screen For Your Card </div>
                                 <h2 class="card_connect">Connect Your Card to a Screen</h2> 
								  <div class="clear"></div>
                                <span class="connect_add_more">Connect this card to an existing screen in the app or to an existing retail app home screen or link to a website. You can also choose to connect this with specific product or category in an existing retail app.</span>
                                <a href="#" class="read_more">Read More...</a>
                              <div class="clear"></div>
                                <div class="background_label">
                                ...
                                <div class="background_colorbox">
                                  ...
                                  <em>Link your card to any exisiting screen in the app.</em>
                                </div>
								
								<div class="clear"></div>
                              <!-- Image on text Component 58 23-5-16 start-->
                                 <div class="background_label link_text_option">
                                    <label class="screenConnectRadio"><input type="radio" id="screen" name="categoryRadio">Link to Website :</label>
                                </div>
...
-->
                                ...
                                <div class="form_edit_inner_box editDescription">
                                    ...
                                    <div class="content_textbox">
                                        <textarea placeholder="Edit Description" class="notEdit" maxlength="2000"></textarea>
                                        <em>Maximum of 2000 Characters</em>
                                    </div>
                                </div>
                                ...
                                <div class="form_edit_inner_box editRequired">
                                    ...
                                    <div class="content_textbox">
                                        ...
                                        <label for="mandatory">&nbsp;</label>
																	...
																	<div class="form_edit_inner_box editAttachmentType" style="display: block;">
																		<div class="content_label">
																			<label>Select File Type:</label>
																			<div class="label_help_text">(Maximum file size allowed is <strong>2MB</strong>)</div>
																		</div>
																		<div class="content_textbox">
																			<div class="option_label">
																				<label>
																					<input type="radio" name="attachOpts" value="Document">&nbsp; Document (.pdf, .doc, .xlsx)
																				</label>
																			</div>
																			<div class="option_label">
																				<label>
																					<input type="radio" name="attachOpts" value="Image">&nbsp; Image (.jpg, .png, .gif)
																				</label>
																			</div>
																			<div class="option_label">
																				<label>
																					<input type="radio" name="attachOpts" value="Audio">&nbsp; Audio (.mp3)
																				</label>
																			</div>
																			<div class="option_label">
																				<label>
																					<input type="radio" name="attachOpts" value="Video">&nbsp; Video (.mp4, .avi, .flv)
																				</label>
																			</div>
																		</div>
																	</div>
                        ...
                        $(".deleteSlide").click(function () {
                            if (($("#appName").val()) != '') {
                                if(selectedPageIndex ==1)
                                {
                                    ...
                                    $("#page_ajax").html('').hide();
                                    $(".popup_container").css({'display': 'block'});
                                    $(".confirm_name .confirm_name_form").html('<p>Home Screen can not be deleted.</p><input type="button" value="OK">');
                                    $(".confirm_name").css({'display': 'block'});
                                    return false;
                                }
...
<script type="text/javascript" src="js/customFramework.js?r=24"></script>
...
function selectedcategory() {	
				...
				$( "#selectedcategory" ).removeClass( "selectmaincategory" ).addClass( "zzppss" );		   
...
function selectedsubcategory() {
	...
	var getvalcat = $('#selectsubcategories').val();	
	//  $('.selectedsubcategory').removeAttr('id');
                // Code by Kanishka
                var strAttr = '';
                $.each($("#present")[0].attributes, function () {
                    if (this.specified && (this.name.indexOf('select-subcategory') !== -1)) {
				...
				$('#screenoverlay').fadeIn();
					...
					var lastsubcategory=$(".selectedsubcategory:last option:selected").val();
					if(lastsubcategory != "0"){
					var formData = {'app_id': app_id, 'category_id': category_id};
					$(".popup_container").css("display", "block");
					$("#page_ajax").html('<img class="loader_new" src="images/ajax-loader_new.gif">').show();
					$.ajax({
...
var valmaincat = $('#present').attr('data-maincategory');
						 ...
						 $("#page_ajax").html('<img class="loader_new" src="images/ajax-loader_new.gif">').show();
								...
								url: "ajax_category.php",
										...
										success: function (response) {
											...
											if(typeof valmaincat != 'undefined'){
			...
			// when already there is selected category for the component
			 $(document).on('click', '.selectmaincategory',categoryClick);			
			$(document).on('change','.selectedsubcategory',selectedsubcategory);
			// when already there is selected subcategory for the component
		//	$(document).on('click','#selectsubcategories',selectedsubcategory);			
			$(document).on('change','#selectedproduct',selectedproduct);
			// when already there is selected subcategory for the component
			//$(document).on('click','.mainselectedproduct',selectedsubcategory);
			
			
			function selectedproduct() {
                $("#present").attr("data-product", $(this).val());
                $("#present").attr("data-product-name", $('option:selected',this).html());
                updateHierarchy();
            }
...
<script type="text/javascript" src="js/trackuser.jquery.js?v=2"></script>
</body>
</html>
