...
$results=ip_visitor_country();
$country=$results['geoplugin_countryCode'];
$date = date_default_timezone_set('Asia/Kolkata');
$timenow =date('H:i:s');
$curr_time=strtotime($timenow); 
 
 $curr_time1=strtotime('4:30:00');

 $curr_time2=strtotime('11:00:00');
...
<div class="big-cont mt0 suc">
	<div class="contact_us">
    	<div class="contact_us_left">
        	<h2 style="text-transform:none;">Say Hello! <?php 
if($country == 'US' ){	
if($curr_time > $curr_time1  && $curr_time < $curr_time2){
...
<?php require_once('website_footer-pravat.php');?>
