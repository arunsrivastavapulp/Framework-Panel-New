...
<?php if ($gcode) echo "Verification";
else if ($approve_gcode) echo "Request Approve";
else if ($rejected_gcode) "Request Reject";
else echo "Register"; ?></a> </div>
    </div>
</div>
<div class="clear"></div>
...
<script>
      ga('set', 'userId', {{<?php echo $_SESSION['custid'];?>}}); 
</script>
<?php
}
?>
