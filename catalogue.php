...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".appbannereditbrowse").click(function () {
            $(".modal-title").html("Cropper (1080px X 540px ).<br/><p class='zoomtext'> Scroll to zoomin and zoomout.</p>");
    ...
    $(document).ready(function () {
        ...
        $(".editbrowse").click(function () {
            $(".modal-title").html("Cropper (500px X 500px ).<br/><p class='zoomtext'> Scroll to zoomin and zoomout.</p>");
