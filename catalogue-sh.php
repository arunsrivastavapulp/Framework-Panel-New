...
<section class="main" ng-controller="catalogueController">
   ...
   <header>
      ...
      <ul class="top-aside">
         <!--ng-show="fnShowField('catProdSelect') || fnShowField('imgHeadSubhead') || fnShowField('onlyCatWithProdDropdwn')"-->
         <?php
         ...
         <?php }?>
         <li><a class="make_app_next addproduct" href="" ng-click="sendToOpencart()">Add Products</a></li>
            ...
            <div class="mid_section_right">
               ...
               <div class="mid_right_box additional-features" ng-class="{ 'active': currentBlock === 4 }">
                  ...
                  <div class="mid_right_box_body" ng-show="currentBlock === 4">
                     <div class="design_menu_box">
                        <!-- 22-08-2016 start -->
                        <div class="catalogue_add_feature getReviewAndRating">
                          <div class="catalogue_input_group">
                            <input type="checkbox" value="1" ng-model="appDtls.review_rating">
                            <label for="feedback">Get review and rating for your products</label><br>
                            <span>With this section your user will be able to view and give rating of your product.</span>
                            <div class="clear"></div>
                          </div>
                        </div>
                        <!-- 22-08-2016 end -->
                           ...
                           <div class="catalogue_detail_input">
                              <ul>
                                 ...
                                 <li class="fullLength">
                                    ...
                                    <div class="clear"></div>
                                    <span>Enter email id to where you want your users to send their feedback.</span>
                                 </li>
                                 <div class="clear"></div>
                              </ul>
                           </div>
                           ...
                           <div class="catalogue_detail_input">
                              <ul>
                                 ...
                                 <li class="fullLength">
                                    ...
                                    <div class="clear"></div>
                                    <span>Enter email id to where you want your users to contact you for help.</span>
                                 </li>
                                 <div class="clear"></div>
                              </ul>
                           </div>
                           ...
                           <div class="catalogue_detail_input">
                              <ul>
                                 ...
                                 <li class="fullLength">
                                    ...
                                    <div class="clear"></div>
                                    <span>Enter URL for Terms &amp; Conditions Page</span>
                                 </li>
                                 <div class="clear"></div>
                              </ul>
                           </div>
...
<script>
   ...
   var app_bg_color = '<?php echo $app_data['background_color']; ?>';
   ...
   var reseller_id='<?php echo $_SESSION['cust_reseller_id'];?>';
   var is_reseller='<?php echo $_SESSION['is_reseller'];?>';
</script>
<!-- script src="js/require.js,js/require.config.js,js/main-catalogue.js"></script -->
<script src="js/require.js"></script>
<script src="js/require.config.js"></script>
<script src="js/main-catalogue-sh.js"></script>
<!-- script src="js/retail-ug_latest.js"></script -->
