var storedLayouts = [
  ...
  {
    index: '9',
    layout: '<div class="half_widget fontfamily layout1" data-component="7"><p class="widgetClose">x</p><div class="half_widget_img"><img src="' + BASEURL + 'images/widget_img.jpg"><img class="video_img" alt="" src="' + BASEURL + 'images/video_img_half.png"><div class="clear"></div></div><div class="half_widget_text"><p>Heading</p></div></div><div class="half_widget fontfamily layout1" data-component="7"><p class="widgetClose">x</p><div class="half_widget_img"><img src="' + BASEURL + 'images/widget_img.jpg"><img class="video_img" alt="" src="' + BASEURL + 'images/video_img_half.png"><div class="clear"></div></div><div class="half_widget_text"><p>Heading</p></div></div><div class="half_widget fontfamily layout1" data-component="7"><p class="widgetClose">x</p><div class="half_widget_img"><img src="' + BASEURL + 'images/widget_img.jpg"><img class="video_img" alt="" src="' + BASEURL + 'images/video_img_half.png"><div class="clear"></div></div><div class="half_widget_text"><p>Heading</p></div></div><div class="half_widget fontfamily layout1" data-component="7"><p class="widgetClose">x</p><div class="half_widget_img"><img src="' + BASEURL + 'images/widget_img.jpg"><img class="video_img" alt="" src="' + BASEURL + 'images/video_img_half.png"><div class="clear"></div></div><div class="half_widget_text"><p>Heading</p></div></div><div class="small_widget custom_widget2 layout1 layout8 layout9" data-component="33"><p class="widgetClose">x</p><a href="http://www.facebook.com/yourProfile"><div class="small_widget_img"><img src="' + BASEURL + 'images/facebook.png" alt="Image Not Found"></div><div class="small_widget_text"><p>Like us on </p><h2>Facebook</h2></div><div class="clear"></div></a></div><div class="contact_small_widget layout1" data-component="29"><p class="widgetClose">x</p><p class="contact_small_heading">Heading</p><p class="contact_small_subheading">Subheading</p><div class="contact_btns"><a href="#" class="your_mail"><img src="' + BASEURL + 'images/contact_mail.png" /></a><a href="#" class="your_phone"><img src="' + BASEURL + 'images/contact_phone.png" /></a></div></div>',
    banner: '<img src="' + BASEURL + 'images/widget_full_img_only.jpg" class="active"><img src="' + BASEURL + 'images/widget_full_img_only.jpg"><img src="' + BASEURL + 'images/widget_full_img_only.jpg"><div class="pager"><div class="active"></div><div></div><div></div></div><div class="clear"></div>'
},
  {
    index: '10',
  ...
  {
    index: '21',
    layout: '<div class="label_left_textbox common_form_box" data-ss-colspan="2" data-component="25"><p class="widgetClose">x</p><div class="label_left"><label class="common_input_label">Label Text</label></div><div class="textbox_right"><input type="text" disabled placeholder="Hint Text" class="common_input_textbox"></div><div class="common_input_overlay"></div></div><div class="full_textbox_Label common_form_box layout21" data-ss-colspan="2" data-component="26"><p class="widgetClose">x</p><label class="common_input_label">Label Text</label><div class="full_textbox_inner"><input type="text" disabled="" placeholder="Hint Text" class="common_input_textbox" style="background:#fff;"></div><div class="common_input_overlay"></div></div><div class="label_left_tabbtn common_form_box layout21" data-ss-colspan="2" data-component="47"><p class="widgetClose" style="display: block;">x</p><div class="tabbtn_label_left"><label class="common_input_label">Label Text</label></div><div class="tabbtn_right"><ul class="clearfix"><li class="active"><a href="#" class="common_main_color">Text 1</a></li><li><a href="#">Text 2</a></li></ul></div><div class="common_input_overlay"></div></div><div class="full_textbox_date common_form_box layout21" data-ss-colspan="2" data-component="50"><p class="widgetClose">x</p><div class="full_textbox_inner"><input type="date" disabled="" placeholder="Date (mm/dd/yyyy)" class="common_input_textbox" style="background:#fff;"><div class="common_icon_box"> <span class="icon-calendar146"></span></div></div><div class="common_input_overlay"></div></div><div class="full_textarea_Label common_form_box layout21" data-ss-colspan="2" data-component="54"><p class="widgetClose">x</p><label class="common_input_label">Label Text</label><div class="full_textarea_inner"><textarea disabled placeholder="Hint Text" class="common_input_textarea notEdit" style="background:#fff;" maxlength="50"></textarea></div><div class="common_input_overlay"></div></div><div class="full_button common_form_box" data-ss-colspan="2" data-component="45"><input type="submit" value="Button" class="common_main_color"><div class="common_input_overlay"></div></div>',
}
/*,
 {
 index: '21',
...
/*Navigaction strat*/
  ...
  $.each(pageDetails, function (i, val) {
    //alert("index " + i);
    //alert("value " + val)
    screenName += '<option value="' + val.index + '">' + val.name + '</option>';
  });
  $(".nav_item2").append(screenName);
}
$(window).load(function () {
  updateNavScreen();
  $(".nav-box-area:first select.nav_item2").find("option:nth-child(3)").prop("selected", "selected");
  $(".navItemEdit .nav-box-area").eq(0).find(".addToSlide2").attr("checked", "true");
  $(".navItemEdit .nav-box-area").eq(0).find(".addToSlide2, .nav_item2, .repeat_icon, .repeat_icon > img").attr("disabled", "true")
...
/*Navigaction strat*/
$(document).on('click', '.nav-box-area', naviClick); 
               
function naviClick(){
 $(".nav-box-area").removeAttr("id", "navpresent");
 $(this).attr("id", "navpresent");
}
  
/* repeat screen name show end*/
function OptionEach(){
...
$(document).on('change', '#navpresent .nav_item2', naviChange); 
 function naviChange(){
  var chooseCategory = $(this).find("option:selected").val();
  console.log(chooseCategory);
  if(chooseCategory == "Category"){
   var screenName2 = OptionEach();
    $("#navpresent").find(".repeat-screen-input").html(screenName2);
    $(this).siblings().show();
    $("#navpresent").find(".repeat-screen-name").show();
  }
   else{
     $(this).siblings().hide();
     $("#navpresent").find(".repeat-screen-name").hide();
   }
}
/* repeat screen name show end*/
  
/* click check box start*/    
$(document).on('change', '.addToSlide2', clickCheckBox);
function clickCheckBox(){
  if($("#navpresent .addToSlide2").prop("checked") == true){
    var dataIndexValue = $(this).parents(".nav-box-area").attr("data-ind");
    var navCategoryText = $(this).parents(".nav-box-area").attr("data-ind");
    var subScreenVlaue = $(this).parents(".nav-box-area").attr("data-ind");
    //<li data-link=" +dataIndexValue+ ">" + $(this).parents(".repeat_checkbox").siblings(".navText").find(".nav-cat_name").val()+ "</li>
    $("<li data-link=" +dataIndexValue+ "><a href='#'><span><img src='http://www.instappy.com/images/nav_img.png'></span><span>" + $(this).parents(".repeat_checkbox").siblings(".navText").find(".nav-cat_name").val()+ "</span><div class='clear'></div><div class='sub-cat'></div></a></li>").insertAfter("nav > ul li:nth-last-child(3)");
    alert("true");
    
    /* check sub- screen add time start */
    var selectSubScreenVal = $("#navpresent").find(".repeat-screen-name .repeat-screen-input option:selected");
    if(selectSubScreenVal != "0"){
    var dataIndexText = $(this).parents(".nav-box-area").attr("data-ind");
      var rightSubScreenVal = "";
      $.each(selectSubScreenVal, function (){
        var rightSubScreentext = $(this).text();
        console.log(rightSubScreentext);
        rightSubScreenVal += '<p>'+ rightSubScreentext +'</p>';
      })
      $('nav > ul').find("[data-link='" + dataIndexText + "']").find(".sub-cat").append(rightSubScreenVal);
    }
    else{ 
    }
    /* check sub- screen add time start */
  ...
  if($(this).prop("checked") != true){
      alert("false")
    var dataIndexText = $(this).parents(".nav-box-area").attr("data-ind");
    $('nav > ul').find("[data-link='" + dataIndexText + "']").remove();
    
  }
}
/* click check box end*/   

/* Cloan screen name start*/
$(document).on('click', '#navpresent .repeat-screen-input', inputClick); 
function inputClick(){
  $("#navpresent .repeat-screen-input").parent(".repeat-screen-name").removeAttr("id", "inputpresent");
  $(this).parent(".repeat-screen-name").attr("id", "inputpresent");
}
  $(document).on("change", "#navpresent #inputpresent", function(){
    var presSlecectScreenVal = $(this).find("option:selected").val();
    var dataIndexText = $("#navpresent").attr("data-ind");
    if(presSlecectScreenVal != "0"){
      alert(presSlecectScreenVal);
      var screenName2 = OptionEach();
      $("<div class='repeat-screen-name'><select class='repeat-screen-input'>"+screenName2+"</select><i class='fa fa-trash deleteNavslide'></i></div>").insertAfter(this).last().css({"display" : "block"});
      
       
      if($("#navpresent").find(".addToSlide2").prop("checked") == true){
        alert("this is true");
        var rightSubScreenVal = "";
        var selectSubScreenVal = $("#navpresent").find(".repeat-screen-name .repeat-screen-input option:selected");
        $.each(selectSubScreenVal, function (){
        ...
        $('nav > ul').find("[data-link='" + dataIndexText + "']").find(".sub-cat").html(rightSubScreenVal);
      }
...
/* Cloan screen name end*/
  
/* delect screen-name box start*/
$(document).on('click', '#navpresent .deleteNavslide', function(){
  var deletScreenName = $(this).siblings(".repeat-screen-input").find("option:selected").text();
  var dataIndexDelete = $("#navpresent").attr("data-ind");
  var screenlength = $("#navpresent .repeat-screen-name").length
 // alert("Delete Screen Box " + deletScreenName);
  var subCatvalue = $('nav > ul').find("[data-link='" + dataIndexDelete + "']").find(".sub-cat p");
  if(screenlength > 1){
  $(this).parent(".repeat-screen-name").remove();
  $.each(subCatvalue, function(i, val){
   var subCattext = $(this).text();
    if(deletScreenName == subCattext){
    $(this).remove();
    alert("Remove")
    }
   });
    ...
    $(".popup_container").css({
      ...
      $(".confirm_name .confirm_name_form p").html('Sorry This is not Delete');
      $(".confirm_name").css({
        'display': 'block'
      });
  }
});
/* delect screen-name box end*/
  
/* check repeat screeen input start*/
  
/* check repeat screeen input end*/  
...
/*Navigaction end*/
  ...
  function languagegetClick(event) {
    ...
    $(this).attr("headingValue", $("#present").find(".ariba-text-change > h2").text());
  ...
  $(".ariba-text").on('keyup', function (e) {
    ...
    if (txtVal == "") {
      var aribaHeadingAttr = $("#present.language").attr("headingValue");
      $(".popup_container").css({
        'display': 'block'
      });
      $(".confirm_name .confirm_name_form p").html('Please Enter Heading');
      $(".confirm_name").css({
        'display': 'block'
      });
      $('#present .ariba-text-change > h2').text(aribaHeadingAttr);
      $(this).val(aribaHeadingAttr);
    } else {
  ...
  function businessWidgetClick() {
    ...
    if ($("#present").hasClass("business-card-phone")) {
      ...
      $(".business-phone").on('keyup', function (e) {
  ...
  $(".heading").on('input propertychange', function () {
    var txt7 = $(this).val().trim();
    if ($("#present").hasClass("contact_widget")) {
      if (txt7 == "") {
        var contactWidgetAttr = $("#present").attr("headingValue");
        $(".popup_container").css({
          'display': 'block'
        });
        $(".confirm_name .confirm_name_form p").html('Please Enter Heading');
        ...
        $("#present").find(".contactus").text(contactWidgetAttr);
        $(this).val(contactWidgetAttr);
      } else {
    $("#present").find(".contactus").text($(this).val());
      }
    }
    if (txt7 == "") {
      var headerDescripAttr = $("#present").attr("headingValue");
      $(".popup_container").css({
        'display': 'block'
      });
      $(".confirm_name .confirm_name_form p").html('Please Enter Heading');
      ...
      $("#present").find(".item_heading").text(headerDescripAttr);
      $(this).val(headerDescripAttr);
    } else {
    $("#present").find(".item_heading").text($(this).val());
    }


    if ($("#present").hasClass("contact_small_widget")) {
      if (txt7 == "") {
        var headingAttr = $("#present").attr("headingValue");
        $(".popup_container").css({
          'display': 'block'
        });
        $(".confirm_name .confirm_name_form p").html('Please Enter Heading');
        ...
        $("#present").find(".contact_small_heading").text(headingAttr);
    ...
    if ($("#present").hasClass("head_disc_widget")) {
      if (txt7 == "") {
        var headWidgetAttr = $("#present").attr("headingValue");
        $(".popup_container").css({
          'display': 'block'
        });
        $(".confirm_name .confirm_name_form p").html('Please Enter Heading');
        ...
        $("#present").find(".head_disc_content h2").text(headWidgetAttr);
        $(this).val(headWidgetAttr);
      } else {
  ...
  $(".subHeading3").on('input propertychange', function () {
    ...
    /*if ($('#present').hasClass('change_text_option')) {
       var txt3 = $(this).val().trim();
       if(txt3 == ""){
         var SocialSubHeading3Attr = $("#present").attr("subheadingValue");
         $(".popup_container").css({'display': 'block'});
        $(".confirm_name .confirm_name_form p").html('Please enter Social Card Sub Heading');
        $(".confirm_name").css({'display': 'block'});
        $("#present").find(".change_text_area p").text(SocialSubHeading3Attr);
        $(this).val(SocialSubHeading3Attr);
      }
      else{
    ...
    if ($("#present").hasClass("custom_widget2")) {
      var SocialCardSubHeadingVal = $(this).val().trim();
      if (SocialCardSubHeadingVal == "") {
        var headingValue = $("#present").attr("headingValue");
        $(".popup_container").css({
          'display': 'block'
        });
        $(".confirm_name .confirm_name_form p").html('Please Enter Social Card Sub Heading');
        ...
        //alert(SocialSubHeadingAttr);
        $("#present").find(".small_widget_text > h2").text(headingValue);
        $(this).val(headingValue);
      } else {
  ...
  function headDiscWidgetClick() {
    ...
    $("div.nicEdit-main").addClass('wordwrap');
    $(this).attr("id", "present");
    $(this).attr("headingValue", $("#present").find('.head_disc_content h2').text());
    // edit 4 option
  ...
  function calenderWidgetClick() {
    ...
    $('.change_properties').removeClass('change_properties');
    $('.calenderDate').show();
    $(this).attr("headingValue", $('#present h2.calendar-heading').text());
  ...
  $('.calenderHead').on('input propertychange', function () {
    ...
    if (txt4 == "") {
      ...
      $('#present h2.calendar-heading').text(headingValue);
      $(this).val(headingValue);
    } else {
  ...
  function contactSmallWidgetClick() {
    ...
    $(".screen_name").val($("#pageSelector option:selected").text());
    $(this).attr("id", "present");
    $(this).attr("headingValue", $("#present").find(".contact_small_heading").text());
    $(".enter_phone").val($("#present a.your_phone img").attr("data-linkPhone"));
    $(".enter_email").val($("#present a.your_mail img").attr("data-linkemail"));
  ...
  function contact_card_edit() {
    ...
    /*12-7-16 end*/
    $(this).attr("id", "present");
    $(this).attr("headingValue", $("#present").find('.contact_card_text').children("p").text());
    /*12-7-16 start*/
  ...
  $('.editCheckboxList .content_textbox .dropdownList_btn').on('click', function () {
    if ($(this).prev('.dropdownList').val() != '') {
      ...
      var checkboxLength = $('.mobile .check_input_box .check_input_box_inner').length;
      ...
      $('<div class="check_input_box_inner" data-index="' + checkboxLength + '"><div class="check_left"><input type="checkbox"></div><div class="check_label_right"><label class="common_input_label">' + newCheckbox + '</label></div></div>').insertAfter('.mobile .check_input_box .check_input_box_inner:last');
      globalRestart();
    }
  });
  $('.editRadioList .content_textbox .dropdownList_btn').on('click', function () {
    if ($(this).prev('.dropdownList').val() != '') {
      var newCheckbox = $(this).prev('.dropdownList').val();
      $('.newCheckBox').removeClass('newCheckBox');
      var radioLength = $('.mobile .radio_input_box .radio_input_box_inner').length;
      ...
      $('<div class="radio_input_box_inner" data-index="' + radioLength + '"><div class="radio_left"><input type="radio"></div><div class="radio_label_right"><label class="common_input_label">' + newCheckbox + '</label></div></div>').insertAfter('.mobile .radio_input_box .radio_input_box_inner:last');
  ...
  function fullTextboxDateClick() {
    ...
    if ($(this).find(".full_textbox_inner input:date").prop('required')) {
      $('.editRequired .content_textbox input:checkbox').prop('checked', 'checked');
    } else {
      $('.editRequired .content_textbox input:checkbox').removeAttr('checked');
    }
  ...
  function smallWidgetClick(event) {
    ...
    if ($('#present').hasClass('custom_widget')) {
      ...
      $(".widgetEdit").show();
      $(".widgetEdit .mapwidgetEdit").show();
      $(this).attr("headingValue", $("#present").find('.small_widget_edit_text p').text());
    ...
    if ($('#present').hasClass('custom_widget2')) {
      ...
      $(this).attr("headingValue", $("#present").find('.small_widget_text p').text());
      //$(this).attr("subheadingValue", $("#present").find('.small_widget_text h2').text());
  ...
  function fullItemWidgetClick() {
    ...
    $(".link_text_option").hide();
    $(this).attr("id", "present");
    $(this).attr("headingValue", $("#present").find('.item_heading').text());
  ...
  function bigWidgetClick() {
    ...
    $(this).attr("id", "present");
    $(this).attr("headingValue", $("#present").find('.img_heading').text());
    $(".editbrowse").not($('.createLogin .editbrowse')).attr("src", $("#present img").attr("src"));
  ...
  $(".big_widget_head").on('input propertychange', function (e) {
    var txt9 = $(this).val().trim();
    if (txt9 == "") {
      var bigWidgetVal = $("#present").attr("headingValue");
      $(".popup_container").css({
        'display': 'block'
      });
      $(".confirm_name .confirm_name_form p").html('Please Enter Heading');
      ...
      $("#present .img_heading").text(bigWidgetVal);
      $(this).val(bigWidgetVal);
    } else {
  ...
  $(".big_text_head1").on('input propertychange', function (e) {
    var txt8 = $(this).val().trim();
    if (txt8 == "") {
      var bigtextAttr = $("#present").attr("headingValue");
      $(".popup_container").css({
        'display': 'block'
      });
      $(".confirm_name .confirm_name_form p").html('Please Enter Heading');
      ...
      $("#present .img_heading").text(bigtextAttr);
      $(this).val(bigtextAttr);
    } else {
    $("#present .img_heading").text($(this).val());
    }
  });
  ...
  function widgetClick() {
    ...
    if ($('#present').hasClass('change_text_option')) {
      $(".compoNent58").show();
      $(".widgetEdit.mapwidgetEdit").hide();
      $(this).attr("headingValue", $("#present").find('.change_text_area h2').text());
    ...
    if ($('#present').hasClass('round_widget')) {
      ...
      $(".circleTheme").show();
      $(".circleItemEdit").show();
      $(this).attr("headingValue", $("#present").find('.round_widget_text p').text());
    ...
    if ($("#present").hasClass("fontfamily")) {
      ...
      $(this).attr("headingValue", $("#present").find('[class$="_widget_text"]').children("p").text());
    }

    if ($("#present").hasClass("fontchange")) {
      $(this).attr("headingValue", $("#present.fontchange").find('.full_widget_text p').text());
 ...
 /*Navigaction strat*/
  ...
  function map_full_widgetClick() {
    ...
    $(".mid_right_box.change_properties").removeClass("change_properties");
    $(this).attr("id", "present")
    $(this).attr("headingValue", $("#present").find('.full_widget_text p').text());
    $(".editPicker").css("background-color", $("#present p").css("color"));
  ...
  function headContWidgetClick() {
    ...
    $(".screen_name").val($("#pageSelector option:selected").text());
    $(this).attr("id", "present")
    $(this).attr("headingValue", $("#present.head_cont").find('.img_heading').text());
  ...
  $(".content_textbox_edit1").on('input propertychange', function () {
    ...
    if (txt1 == "") {
      ...
      $("#present").find("p.img_heading").text(headingAttr);
      $(this).val(headingAttr);
    } else {
      $("#present").find("p.img_heading").text($(this).val());
    }
  });
  ...
  $('.content_textbox_edit').on('input propertychange', function () {
    ...
    if (txt1 == "") {
      var SocialHeadingAttr = $("#present").attr("headingValue");
      $(".popup_container").css({
        'display': 'block'
      });
      $(".confirm_name .confirm_name_form p").html('Please Enter Heading');
      ...
      $("#present").find('[class$="_widget_text"]').children("p").text(SocialHeadingAttr);
      $("#present").find('.contact_card_text').children("p").text(SocialHeadingAttr);
      $(this).val(SocialHeadingAttr);
    } else {
    ...
    if ($('#present').hasClass('custom_widget')) {
      if (txt1 == "") {
        var SocialHeadingAttr = $("#present").attr("headingValue");
        $("#present").find(".small_widget_edit_text p").text(SocialHeadingAttr);
        $(this).val(SocialHeadingAttr);
      } else {
    ...
    if ($('#present').hasClass('change_text_option')) {
      if (txt1 == "") {
        var SocialHeadingAttr = $("#present").attr("headingValue");
        var SocialSubHeadingAttr = $("#present").attr("subheadingValue");
        $("#present").find(".change_text_area h2").text(SocialHeadingAttr);
        $("#present").find(".change_text_area p").text(SocialSubHeadingAttr);
        $(this).val(SocialHeadingAttr);
      } else {
  ...
  function navOpenFunction(e) {
    ...
    //   $(".mobile nav").append("<div class='navfooter'><p >Powered By Instappy.</p><p >Â© 2015 Instappy.com All Rights Reserved</p></div>")
    // }
