	...
	$(".addToSlide").on('change', function () {
		...
		if (currentClick.prop("checked") == true) {
			...
			if (typeof isSpan == 'undefined') {
				var finalHtml = '<li data-link="1"><a href="#" style="cursor: n-resize;"><span><img src="http://www.instappy.com/images/nav_img.png" class="mCS_img_loaded"></span><span>Home</span><div class="clear"></div></a></li>';
			} else {
				...
				if (typeof findClass == 'undefined') {
					...
					var finalHtml = '<li data-link="1"><a href="#" style="cursor: n-resize;"><span class="' + lastClass + '"></span><span>Home</span><div class="clear"></div></a></li>';
				}
			}
			//var finalHtml = '';
