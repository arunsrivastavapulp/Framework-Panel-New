requirejs(['jquery'], function ($) {
	//$(document).ready(function () {
		var TrackUserActivity = {
			CaptureRecord : function($event_name,$href,$iatrack,$mycat_id,$mytheme_id,$mycard_id,$appid){
				...
				var uniqueid=readCookie("uniqueID");
	...
	//For Cards By Pravat	
		...
		if($(this).attr("data-cid"))
			...
			href = href.replace(".php", "");
			var mycard_id = $(this).attr("data-cid");
			var iatrack = 'IA101000'+$(this).attr("data-cid");
			TrackUserActivity.CaptureRecord('Draged-card',href,iatrack,gl_cat_id ,gl_theme_id,mycard_id,'');	
