...
function updateSlideNames() {
	...
	for (var i = 0; i < pageDetails.length; i++) {
		...
		if (linkValue != 'Create Category' && isNaN(linkValue) == false) {
			...
			$(".navCategoryList").eq(i).val('Choose Screen');
			if (selectcatText != '') {
		...
		if (typeof className == 'undefined' || className == 'icon-report') {
			$('.menu_body_links').eq(i - 1).find(".icon_upload_img").replaceWith("<img src='http://www.instappy.com/images/menu_img.jpg' alt='Image Not Found' class='icon_upload_img'>");
		} else {
			$(".menu_body_links").eq(i).find(".icon_upload_img").replaceWith('<span class="icon_upload_img"></span>');
...
function firstUpdateSlideNames() {
	...
	$("nav > ul li").each(function (index) {
		...
		if (isNaN(linkValue) == false || linkValue == 'Create Category') {
			checkVal = index + 1;
			$(".menu_links").find('[data-ind="' + checkVal + '"]').find(".addToSlide").prop("checked", "true");
			$(".menu_links").find('[data-ind="' + checkVal + '"]').find(".navCategoryList").attr("disabled", "true");
			$(".menu_links").find('[data-ind="' + checkVal + '"]').find(".navSubCategoryList").attr("disabled", "true");
		} else {
			$(".navCategoryList option[value*='" + linkValue + "']").prop('disabled', true);
			$(".navSubCategoryList option[value*='" + linkValue + "']").prop('disabled', true);
		}
...
//		$('.nicEdit-main').width('100%');
		...
		$(".contact1Widget .subHeading1").val($("#present").find(".address").text());
		$(".contact1Widget .subHeading2").val($("#present").find(".phone").text());
	...
	$(".subHeading1").on('input propertychange', function () {
		...
		if($("#present").hasClass("contact_widget")){
			 $("#present").find(".address").text($(this).val());
		}
	...
	$(".subHeading2").on('input propertychange', function () {
		...
		if($("#present").hasClass("contact_widget")){
			 $("#present").find(".phone").text($(this).val());
		}
		globalRestart();
	});
	...
	$(".addToSlide").change(function () {
		if ($(this).prop("checked") == true) {
			$(this).parents(".menu_body_links").find(".navCategoryList").prop('disabled', true);
			...
			var categoryIndex = '';
			categoryIndex = $(this).parents(".menu_body_links").index();
			var currentNav = $(this).parents(".menu_body_links").find(".navCategoryList option:selected").val();
			if (currentNav == 'Create Category') {

				var categoryvalue = $(this).parents(".menu_body_links").find(".nav-cat_name").val();
				if (categoryvalue != '') {
					var allsubcat = '';
					$(this).parents(".menu_body_links").find(".navSubCategoryList option:selected").each(function (index) {

						var currentSubNav = $(this).parents(".menu_body_links").find(".navSubCategoryList option:selected").eq(index).val();
						var currentTextValue = $(this).parents(".menu_body_links").find(".navSubCategoryList option:selected").eq(index).text();
					...
					$("<li cat-index='" + categoryIndex + "' data-link='Create Category' ><a href='#'><span class='" + $(this).parent().next().children('span').prop('class') + "'></span><span>" + categoryvaluelist + "</span><div class='clear'></div></a></li>").insertAfter("nav > ul li:nth-last-child(3)");
				} else {
				...
				//				var subcategoryvalue = $(this).parents(".menu_body_links").find(".navSubCategoryList option:selected").val();
				//				if(subcategoryvalue == "choose"){
				//					$(".navCategoryList option[value*='Choose Screen']").prop('disabled', false);
				//					$(".popup_container").css({
				//					  'display': 'block'
				//					});
				//					$(".confirm_name .confirm_name_form p").html('Please Choose Sub Category');
				...
				$("<li data-link=" + currentNav + " data-original-index=" + pageDetails[currentNav - 1].originalIndex + "><a href='#'><span class='" + $(this).parent().next().children('span').prop('class') + "'></span><span>" + $(this).parent("li").siblings(".navText").find(".navCategoryList option:selected").text() + "</span><div class='clear'></div></a></li>").insertAfter("nav > ul li:nth-last-child(3)");
		...
		if ($(this).prop("checked") == false) {
			...
			if (selectedVal == 'Create Category' || selectedVal == 'Choose Screen') {
				...
				$('nav > ul').find("[data-link='" + $(this).parents(".menu_body_links").find(".navCategoryList option:selected").val() + "']").remove();
			}
	...
	function selectedIcon() {
		...
		if ($("#presentIcon").hasClass("social_icon_replace")) {
			...
			$("#presentIcon").find(".icon_upload_img").replaceWith('<span class="icon_upload_img"></span>');
			$("#presentIcon").find("span.icon_upload_img").addClass($(this).children('span').prop('class'));
			$('nav > ul').find("[data-link='" + iconcatvalue + "']").find("span").eq(0).find("img").remove();
			$('nav > ul').find("[data-link='" + iconcatvalue + "']").find("span").eq(0).attr("class", "");
			$('nav > ul').find("[data-link='" + iconcatvalue + "']").find("span").eq(0).addClass($(this).children('span').prop('class'));
	...
	$(".navCategoryList").on('input propertychange', function () {
...
$(document).on('change', '.navSubCategoryList', function () {
	...
	var deletHtml = $('<i class="fa fa-times-circle fa-lg deletScreen"></i>');
...
$(document).on('click', '.deletScreen', function () {
	var subcatValue = $(this).prev(".navSubCategoryList option:selected").val()
	console.log(subcatValue);
	$("nav ul li").each(function (index){
		//alert("each");
		$(this).find("p").find("[data-link='" + subcatValue +"']").remove();
	});
