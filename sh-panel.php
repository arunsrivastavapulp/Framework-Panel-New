<?php
require_once('includes/sh-header.php');
...
?>
<link href="css/sh-cropper.css" rel="stylesheet">
<link href="css/main.css" rel="stylesheet">
<link href="css/sh-custom-style.css" rel="stylesheet">
                        ...
                        <div class="mid_right_box_body">
                            <div class="utility_api_cards">
                                <div class="utility_api_content clones container">
                                    ...
                                    <!-- Image on text Component 58 23-5-16 start-->
                                      <div class="full_widget change_text_option layout1 layout3 layout8 layout9" data-component="58" data-ss-colspan="2">
                                        <p class="widgetClose">x</p>
...
<!-- form cards starts -->
                                 ...
                                 <div class="full_textbox_date common_form_box layout21" data-ss-colspan="2" data-component="50">
                                  ...
                                  <div class="business-card business-card-phone layout23" data-ss-colspan="2" data-component="60">
                                    ...
                                    <div class="business-card business-card-map layout23" data-ss-colspan="2" data-component="60" business-longitude="0" business-latitude="0">
                                      <p class="widgetClose">x</p>
                                      <div class="mapview">
                                      <p>Map View</p>
                                      </div>
                    ...
                    <div class="mid_right_box change_properties">
                        ...
                        <div class="mid_right_box_body">
                            ...
                            <div class="design_menu_box eventItemEdit">
                                ...
                                <div class="change_image">
                                    <input type="file" id="editbrowse_img otherimgs">
                                    <img src="<?php echo $basicUrl; ?>images/browse_full_img.jpg" class="editbrowse eventcircul appbannereditbrowse" alt="Image Not Found">
                                    <!-- <span>Image</span> -->
                                </div>
                                <div class="clear"></div>
                            </div>
...
<script src="js/sh-cropper.js"></script>
<script src="js/main.js"></script>

<script type="text/javascript" src="js/colpick.js"></script>
<script type="text/javascript" src="js/sh-customFramework.js?r=5"></script>
        ...
        $(".editbrowse").click(function () {
            ...
            if (clicked == 0) {
              ...
              if (w == "60" && h == "60") {
                    ...
                    canvasW = 100;
                    aspect = 2;
                     $('.cropper-view-box').css({'border-radius':'0.5'});
                    $(".modal-title .resolution").html("500px &times; 500px");
              }
               /* round card*/
