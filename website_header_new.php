...
?>
    ...
    <head>
        ...
        <meta name="twitter:description" content="<?php echo $db->meta_tags($page, 'meta_description'); ?>" />
			<?php $imgName= $db->meta_tags($page, 'image'); 
		if($imgName == '' || $imgName == null)
		{
			$imgName='http://www.instappy.com/images/instappymeta.png';
		}
		?>
        <meta name="twitter:image" content="<?php echo $imgName;?>" />
        ...
        <meta property="og:image" content="<?php echo $imgName;?>" />
    ...
    <body>
        <section id="main-wrap">
            <div id="screenoverlay" style="height: 100%; width: 100%; position: fixed; background: #000; opacity: 0.7; top: 0; left: 0; z-index: 99999;"> <img class="loader_new" src="images/ajax-loader_new.gif" alt="Create App - Ajax Loader" title="Create App - Ajax Loader" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); -webkit-transform: translate(-50%, -50%); -moz-transform: translate(-50%, -50%); -o-transform: translate(-50%, -50%);"> </div>
            <div class="top_nav">
                    ...
                    <div class="top_nav_right">
					  <div id="showTollFree"></div>
                        <?php if (!empty($_SESSION['custid'])) { ?>
                            <p>
                              <a href="<?php echo $basicUrl . 'applisting.php'; ?>" ia-track="IA10100028">My Apps</a>
                            </p>
                        <?php } else { ?>
            ...
            <div class="popup_container">
              ...
              <div class="login_popup"> <span class="close_popup"><img src="images/popup_close.png" alt="App creator-Instappy" title="App Creator-Instappy"></span>
                        ...
                        <div align="center">
                          ...
                          <div id="captcha-wrap" style="display:none;">
                            <div class="captcha-box">
                              <img src="<?php echo $basicUrl; ?>includes/get_captcha.php" alt="Captcha - Instappy" title="Captcha - Instappy" id="captcha" />
                            </div>
                            <div class="text-box">
                            ...
                            <div class="captcha-action">
                              <img src="<?php echo $basicUrl; ?>images/refresh.jpg" alt="Shopping Cart App" title="Shopping Cart App" id="captcha-refresh" />
                            </div>
                          </div>
			  ...
			  <!-- signup popup start-->
              <div class="forgot_popup signup_success_popup"> <span class="close_popup"><img src="images/popup_close.png" alt="App creator-Instappy" title="App Creator-Instappy"></span>
               ...
               <!-- signup popup end-->
              <div class="forgot_popup"> <span class="close_popup"><img src="images/popup_close.png" alt="App creator-Instappy" title="App Creator-Instappy"></span>
                ...
                <div class="forgot_popup_body">
                  ...
                  <p id="ferror_email"></p>
                  <div id="loading_forgot"></div>
                  <p>A mail will be sent to your email id for reset password.</p>
              ...
              <div class="reset_pass"> <span class="close_popup"><img src="images/popup_close.png" alt="App creator-Instappy" title="App Creator-Instappy"></span>
                <div class="reset_pass_head">
                  <h2>Renew your Password</h2>
                </div>
                <div class="reset_pass_body">
                  <form action="" method="post" name="reset_password" id="reset_password" alt="App creator-Instappy" title="App Creator-Instappy">
              ...
              <div class="em_ver" id="eml"> <span class="close_popup"><img src="images/popup_close.png" alt="App creator-Instappy" title="App Creator-Instappy"></span>
