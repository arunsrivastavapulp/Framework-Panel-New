                            ...
                            <div class="payment_left_common app">
                                <div class="payment_left_common_head">
                                    <ul>
                                        ...
                                        <li>Term</li>
                                        <li><a ia-track="IA101000211" href="javascript:void(0);"  class="deleteincart" data-mid="<?php echo $mpid; ?>" id="appid_<?php echo $x; ?>" data-appid ="<?php echo $value['app_id']; ?>"><i class="fa fa-trash"></i></a></li>
                                        <div class="clear"></div>
                                    </ul>
                                </div>
                                        ...
                                        if ($appName['category_name'] != '') {
                                            ...
                                            <li>
                                                ...
                                                if ($value['is_custom'] == 0 && $value['app_customization'] == 0) {
                                                    ...
                                                    ?>
                                                    <select class="years_click" <?php echo $selectBox; ?> id="timePeriod_<?php echo $x; ?>">
                                                ...
                                                <?php } else if ($value['is_custom'] == 1) { ?>	
                                                    <?php
                                                    if ($mypricing->custom_pkg('pkg_time', $value['app_id']) > 1) {
                                                        ?>
                                                        <select class="years_click" <?php echo $selectBox; ?> id="timePeriod_<?php echo $x; ?>">                                                        
                                                        <option value='<?php echo $mypricing->custom_pkg('pkg_time', $value['app_id']);?>' selected><?php echo $mypricing->custom_pkg('pkg_time', $value['app_id']);?> Day</option>
                                                        </select>
                                                    <?php
//                                                        echo '<input type="hidden" name="timePeriod_' . $x . '" id="timePeriod_' . $x . '" value="' . $mypricing->custom_pkg('pkg_time', $value['app_id']) . '">' . $mypricing->custom_pkg('pkg_time', $value['app_id']) . " Days";
                                                        ...
                                                        ?>
                                                        <select class="years_click" <?php echo $selectBox; ?> id="timePeriod_<?php echo $x; ?>">                                                        
                                                        <option value='<?php echo $mypricing->custom_pkg('pkg_time', $value['app_id']);?>' selected><?php echo $mypricing->custom_pkg('pkg_time', $value['app_id']);?> Days</option>
                                                        </select>
                                                    <?php
//                                                        echo '<input type="hidden" name="timePeriod_' . $x . '" id="timePeriod_' . $x . '" value="' . $mypricing->custom_pkg('pkg_time', $value['app_id']) . '">' . $mypricing->custom_pkg('pkg_time', $value['app_id']) . " Day";
                                                    ...
                                                    ?> 
                                                    <input type="hidden" name="plan_custom" class="cust_plan" id="plan_custom_<?php echo $x; ?>" value="<?php echo $value['plan_id']; ?>">
                                                ...
                                                if ($value['app_customization'] == 1) {
                                                    ...
                                                    <?php 
                                                    echo '<input type="hidden" name="timePeriod_' . $x . '" id="timePeriod_' . $x . '" value="'.$years.'">';?>
                                                    <input type="hidden" name="plan_custom" class="cust_plan" id="plan_custom_<?php echo $x; ?>" value="0">
                                                <?php
                                                }
                                            ...
                                            <div class="payment_files_name">
                                                <div class="files_name_left">
                                                    ...
                                                    <?php if ($value['is_custom'] == 0 && $value['app_customization'] == 0) { ?>
                                                        ...
                                                        ?>
                                                        <select <?php echo $selectBox; ?> id="appAllowed_<?php echo $x; ?>" <?php
                                                ...
                                                echo "disabled";
                                                    ...
                                                    if ($value['app_customization'] == 1) {
                                                        ...
                                                        if ($platform == "3") {
                                                            ...
                                                            $inputType = '<input type="hidden" value="Android-iOS" id="appAllowed_' . $x . '">';
                                                        } else if ($platform == "2") {
                                                            $appAllowedS = 'iOS';
                                                            $inputType = '<input type="hidden" value="iOS" id="appAllowed_' . $x . '">';
                                                        } else if ($platform == "1") {
                                                            $appAllowedS = 'Android';
                                                            $inputType = '<input type="hidden" value="Android" id="appAllowed_' . $x . '">';
                                                        }
                                                        ?>	
                                            ...
                                            <div class="payment_files_name">
                                                <div class="files_name_left">
                                                    ...
                                                    <?php if ($value['is_custom'] == 0 && $value['app_customization'] == 0) { ?>	                                                   
                                                        ...
                                                        ?>
                                                        <select <?php echo $selectBox; ?> id="packageType_<?php echo $x; ?>" <?php
                                                        if (count($results_part) > 0) {
                                                            echo "disabled";
                                                        }
                                                        ?>>
                            ...
                            <div class="payment_left_common mp">
                                <div class="payment_left_common_head">
                                    <ul>
                                        ...
                                        <li> </li>
                                        <li><a  ia-track="IA101000212" href="javascript:void(0);" class="deleteincart" id="mpackage_<?php echo $y; ?>" data-mid="<?php echo $mpid; ?>" data-appid=""><i class="fa fa-trash"></i></a></li>
                                        <div class="clear"></div>
                                    </ul>
                                </div>
                                ...
                                <div class="payment_left_common_body no_padding">
                                    <div class="package_box">
                                        ...
                                        if (count($results_part) > 0) {
                                            ...
                                            <?php echo $currencyIcon; ?> <p class="mpackageINR"  id="mptotal_<?php echo $y; ?>"><?php echo round(($mpamount * $countapp), 2); ?></p>
                                                <input type="hidden" value="<?php echo round(($mpamount * $countapp), 2); ?>" class="mpamount"/>
                                            </div>	
        ...
        ?>
                                    ...
                                    <div class="selectdivBox">                                       
                                        ...
                                        <?php
                                        if ($value['is_custom'] = 1 || $value['app_customization'] == 1) {
//											$countapp = count($selectedappArray);
        ...
        ?>
                        ...
                        <div class="promo_code">
                            ...
                            <div class="promo_code_right">
                                ...
                                <input ia-track="IA101000210" type="submit" value="Apply" onclick="discount()">
                            ...
                            <div class="coupon_msg_box">
                                ...
                                <p id="errorMsg4" style="display: none;" class="error_coupon_msg">Your code is not valid for this transaction.</p>
                            </div>
                        </div>
                        <!-- end discount-->
                        <!-- subtotal-->
    ...
    <?php } ?>
                                ...
                                <div class="clear"></div>
                                <a ia-track="IA101000209" href="#" onclick="SetValues()">Proceed to Checkout ></a>
                                <div class="clear"></div>
                            </div>
                            <div class="clear"></div>
                        </div>
    ...
    ?>
    <?php
                                                                        if ($carthavedata[0]['is_partpayment'] == 1 || $carthavedata[0]['crm_discount']!=0) {
        if ($currency == 1) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function (response) {
                                                            ...
                                                            if (response == 1) {
                                                                ...
                                                                $(".confirm_name .confirm_name_form").html('<p>Something went wrong. Please try again.</p><input id="clickK" type="button" value="OK">');
                                                ...
                                                function SetValues() {
                                                    ...
                                                    if (totalapp > 0) {
                                                        ...
                                                        if (totalmp > 0) {
                                                            var totalclassmp = 0;
//                                                                    var totalclassmp2 = 0;
                                                                    var totalMPCheck = $("p[id^='mptotal_']").length;
                                                                    var totalclassmp3 = totalMPCheck-totalmp;
                                                                    if (totalclassmp3 > 0) {
//                                                                        totalclassmp2 = $("select[id^='appName_"+parseFloat(parseFloat(totalclassmp3)+parseFloat(1))+"']").prop("id").split("_")[1];
                                                                        totalclassmp = parseFloat(parseFloat(parseFloat(totalclassmp3)+parseFloat(1)));

                                                                    } else {
                                                                        totalclassmp = 1;
                                                                    }
                                                            for (var y = totalclassmp; y <= totalMPCheck; y++) {
...
//                                                                        totalclassmp2 = $("select[id^='appName_"+parseFloat(parseFloat(totalclassmp3)+parseFloat(1))+"']").prop("id").split("_")[1];
                                                ...
                                                function calculate() {
                                                    ...
                                                    if ((discountS != '') && (discountS != '0') && (discountS != '0.00')) {

                                                        var afterdiscount = (parseFloat(totalT) - parseFloat(discountS)).toFixed(2);
                                                        var totalpay = 0;
                                                        if (currencyCheck == 1) {
                                                            totalpay = (parseFloat(afterdiscount) * service_tax / 100).toFixed(2);
                                                        }
                                                ...
                                                $(document).ready(function () {
                                                    $(document).on("click", "#clickK", function () {
                                                        location.reload();
                                                    });
                                                    ...
                                                    $(".mpackage").click(function () {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            data: 'packageid=' + mpid + '&token=<?php echo $token; ?>' + '&currency=' + currencyCheck + '&od=<?php echo $orderid; ?>',
                                                            success: function (response) {
                                                                if (response == 1) {
                                                                    ...
                                                                    console.log("Please empty your cart.");
                                                                    $(".confirm_name .confirm_name_form").html('<p>If payment type is part payment then please empty your cart first.</p><input type="button" value="OK">');
                                                                    $(".confirm_name").css({'display': 'block'});
                                                                    $(".close_popup").css({'display': 'block'});
                                                                    $(".popup_container").css({'display': 'block'});
                                                                    return false;
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        success: function (response) {
                                                                            if (response == 2) {
                                                                                $(".confirm_name .confirm_name_form").html('<p>Not Added. Try again.</p><input id="clickK" type="button" value="OK">');
                                                                                $(".confirm_name").css({'display': 'block'});
                                                                                $(".close_popup").css({'display': 'block'});
                                                                                $(".popup_container").css({'display': 'block'});
                                                                                return false;
                                                                                ...
                                                                                console.log("Already Added");
                                                                                $(".confirm_name .confirm_name_form").html('<p>Already Added</p><input id="clickK" type="button" value="OK">');
                                                                                $(".confirm_name").css({'display': 'block'});
                                                                                $(".close_popup").css({'display': 'block'});
                                                                                $(".popup_container").css({'display': 'block'});
                                                                                return false;
