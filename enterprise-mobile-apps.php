...
<!--<div class="banner contpublish">
    ...
    <div class="banner contpublish_create enterprise_create">
        ...
        <div class="page-tabs">
        	<li ><a href="content-publishing-apps.php">Pro Content Apps</a></li>
            <li><a href="retail-and-catalogue-app.php">Pro Shopping Apps</a></li>
            <li class="tab-active"><a href="enterprise-mobile-apps.php" >Enterprise Apps</a></li>
        </div>
        <div class="bn-hld">
            <div class="bnt">Mobile can smartly mobilise your fieldforce in an instant.</div>
            <div class="create_app ">
                <a href="#">Create App</a>
                <em>Try for free!</em>
            </div>
            <div class="breadcrumb">
                ...
                <span>>></span>
                <a href="enterprise-mobile-apps.php" class="active_crum">Enterprise Mobile Apps</a>
            </div>
        </div>
                ...
                <ul class="slides">
                    <li>
                            ...
                            <div class="logo-name">
                                ...
                                <div class="logo-heading">
                                    <h3 class="heading-name">
                                        RAJAN SETHI
                                        <sub class="sub-heading-name">FOUNDER, TCB - HIGH END RESTAURANT CHAIN</sub>
                                    </h3>                                
                                </div>
                        ...
                        <div class="logo-content">
                            <p class="content-details">"The California Boulevard app begins by helping our visitors choose the meal of their choice and ends at capturing their delighted reviews."</p>
                            <a href="http://www.instappy.com/success-stories/the-california-boulevard/" class="read-story">Read the full Story</a>                            
                        </div>
                    </li>
                    <li>
                        <div class="logo-img-block">
                            ...
                            <div class="logo-name">
                                ...
                                <div class="logo-heading">
                                    <h3 class="heading-name">
                                        POOJA CHOUDHARY
                                        <sub class="sub-heading-name">FOUNDER, SOGNO - ITALIAN DESIGNER FURNITURE</sub>
                                    </h3>                                
                                </div>
                        ...
                        <div class="logo-content">
                            <p class="content-details">"Our products have come alive on the Sogno app! Our close customers and the first group of people we took an opinion from are highly impressed with the way the app has enlivened the brand."</p>
                            <a href="http://www.instappy.com/success-stories/sognointerno/" class="read-story">Read the full Story</a>                            
                        </div>
                    </li>
                    <li>
                        <div class="logo-img-block">
                            ...
                            <div class="logo-name">
                                ...
                                <div class="logo-heading">
                                    <h3 class="heading-name">GARTNER&apos;S PREDICTION 2017</h3>                                
                                </div>

                            </div>
                        </div>
                        <div class="logo-content">
                            <p class="content-details">As per Gartner, app development is heading towards 5:1 demand-supply ratio. A major fraction of businesses will switch to DIY App Building platforms to fill this app gap.</p>
                            <a href="http://www.instappy.com/blog/our-take-on-gartners-app-gap-prediction-for-2017/" class="read-story btm_margin">Read the full Story</a>                            
                        </div>
                    </li>
                    <li>
                        <div class="logo-img-block">
                            ...
                            <div class="logo-name">
                                ...
                                <div class="logo-heading">
                                    <h3 class="heading-name">JASMEET
                                        <sub class="sub-heading-name">co-founder, studio j - ONLINE FASHION BOUTIQUE</sub>
                                    </h3>                                
                                </div>
                        ...
                        <div class="logo-content">
                            <p class="content-details">"They see, they like, they order. We have got a few calls from people saying they like the purple gown on our app, and would like to place an order. That's when we knew we did the right thing."</p>
                            <a href="http://www.instappy.com/success-stories/studio-j-app/" class="read-story">Read the full Story</a>                            
                        </div>
                    </li>                                            
                    <li>
                        <div class="logo-img-block">
                            ...
                            <div class="logo-name">
                                ...
                                <div class="logo-heading">
                                    <h3 class="heading-name">MOBILE MARKETING STATS</h3>                                
                                </div>

                            </div>
                        </div>
                        <div class="logo-content">
                            <p class="content-details">By 2017, mobile devices will make up 87 percent of the total sales of Internet-enabled technology</p>
                            <!--<a href="#" class="read-story">Read the full Story</a>-->                            
                        </div>
                    </li>            
                    <li>
                        <div class="logo-img-block">
                            ...
                            <div class="logo-name">
                                ...
                                <div class="logo-heading">
                                    <h3 class="heading-name">
                                        RAJENDRA TIWARI
                                        <sub class="sub-heading-name">FOUNDER, ABSS GROUP - THEATRE SCHOOL</sub>
                                    </h3>                                
                                </div>
                        ...
                        <div class="logo-content">
                            <p class="content-details">"Since the launch of our app, our followers and audience have been growing steadily. I am sure it&apos;ll take our theatre group to places."</p>
                            <a href="http://www.instappy.com/success-stories/abss-theatre-group/" class="read-story">Read the full Story</a>                            
                        </div>
                    </li>                   
                    <li>
                        <div class="logo-img-block">
                            ...
                            <div class="logo-name">
                                ...
                                <div class="logo-heading">
                                    <h3 class="heading-name">
                                        DR. H. S. RAWAT
                                        <sub class="sub-heading-name">FOUNDER, ASTROWORLD - ASTROLOGY CONSULTANTS</sub>
                                    </h3>                                
                                </div>
                        ...
                        <div class="logo-content">
                            <p class="content-details">"I always wished to take the online route to reach out in a better way to people seeking astro-help. When I got to know about instant apps by Instappy, I had no reasons left to delay my app any further."</p>
                            <a href="http://www.instappy.com/success-stories/h-s-rawat/" class="read-story">Read the full Story</a>                            
                        </div>
                    </li>
                    <li>
                        <div class="logo-img-block">
                        ...
                        <div class="logo-content">
                            <p class="content-details">78% of smartphone users and 44% of tablet users access a retail site via a mobile app</p>
                            <!--<a href="#" class="read-story">Read the full Story</a>-->                            
                        </div>
                    </li>    
                </ul>
     ...
     <!-- banner slider end -->
			...
			<input type="hidden" name="country_code" id="country_code">
				...
				<div class="cmn">
					<input type="text" class="required" maxlength="100" placeholder="Name" id="lets_talk_name" name="lets_talk_name" value="">
                </div>
				
					<div class="cmn">
						<input type="text" class="required email" maxlength="100" placeholder="Email" id="lets_talk_email" name="lets_talk_email" value="">
	            	</div>
					<div class="cmn mobileNumber">
                        <input type="tel"  maxlength="6" minlength="2" id="mobile_country_code" name='mobile_country_code' class="required" >
						<input type="tel" class="required" maxlength="16" minlength="5" placeholder="Phone No." id="lets_talk_phone" name="lets_talk_phone" value="" onKeyPress="return isNumber(event)">
					</div>	
                <div class='clear'></div>
                <div class="two_input">
	            	<div class="cmn">
				...
				<div class="cmn">
					<input type="checkbox" class="required" name="agree" checked="checked" value="1"/><small>I allow you to contact me via phone calls and electronic methods.</small>
                </div>
...
?>
    ...
    <div class="clear"></div>
<div class="slider-block-small-devices">
    <div class="slider-block">
            <div class="banner-slider">
                <ul class="slides">
                    <li>
...
<div class="clear"></div>
    ...
    <form class="lets_talk_form" name="lets_talk" id="lets_talk" method="post" action="">
                ...
                <div class="two_input">
                    ...
                    <div class="cmn">
                        <input type="tel"  maxlength="6" minlength="2" id="mobile_country_code2" name='mobile_country_code2' class="required" >
                        <input type="text" maxlength="16" minlength="5" placeholder="Phone No." id="lets_talk_phone" name="lets_talk_phone" value="" onKeyPress="return isNumber(event)">
                    </div>  
                </div>
                <div class="two_input">
                    <div class="cmn">
                ...
                <div class="cmn clearfix">
                    <input type="checkbox" class="required" name="agree"  value="1" checked="checked"/><small>I allow you to contact me via phone calls and electronic methods.</small>
                </div>              
                <input type="submit" value="SUBMIT"> 
            </form>
</div>
<div class="page-tabs respon clearfix">
	<ul>
        <li><a href="content-publishing-apps.php">Pro Content Apps</a></li>
        <li><a href="retail-and-catalogue-app.php">Pro Shopping Apps</a></li>
        <li  class="tab-active"><a href="enterprise-mobile-apps.php">Enterprise Apps</a></li>
...
<div class="home-content enterprise-home clearfix" id="createApp">
        <div class="home-tabs scr">
            ...
            <li ><a href="#ct">Campaign Tracker</a></li>
        </div>
        <div class="content1">  
            <div class="msl">
                <i class="mac"></i>
   ...
   /*  $(window).load(function(){
    ...
    $(document).ready(function() {
		...
		$('#letstalk').on('click', function(){
           var country_code = $('.lets_talk_form ul.country-list').find('li.active').attr('data-dial-code');
		   
							  $('#country_code').val(country_code);
			var country_name = $('.lets_talk_form ul.country-list').find('li.active').attr('data-country-code');
