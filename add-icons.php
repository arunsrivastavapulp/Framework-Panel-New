        ...
        ?><div><img class="selected" src="<?php echo $icon['image_40']; ?>" defaulticons="0"></div>
        <?php } else { ?>
        <div><img src="<?php echo $icon['image_40']; ?>" defaulticons="0"></div>
        <?php
        }
        }
        }
        ...
        if (trim(str_replace("&amp;", "&", $sel_icon)) == trim($icon['image_40'])) {
            $II=1;
        ?><h2 class="icon_tip" style="
        float: left;
        margin-bottom: 28px;
        margin-top: -16px;
        margin-left: -40px;
        ">App Icon </h2><div class="clear"></div><div><img class="selected" src="<?php echo $icon['image_40']; ?>"></div>
        <?php } else { ?>
        <div><img src="<?php echo $icon['image_40']; ?>"></div><div class="clear"></div>
        <?php
        }
        }
        }
        ...
        <div><img class="selected" src="<?php echo $self_icon['image_40']; ?>" data-size="<?php echo $size; ?>" defaulticons="1"></div>
        <?php } else { ?>
        <div><img class="selected"  defaulticons="1" src="<?php echo $self_icon['image_40']; ?>" data-size="<?php echo $size; ?>"></div>
        <?php } ?>
        <div class="clear"></div>
        ...
        var defaultvalue=$(".selected").attr("defaulticons");
        ...
        ?><div class="uploaded_icons"><img class="selected" src="<?php echo $icon['image_40']; ?>" defaulticons="0"></div>
        <?php } else { ?>
        <div class="uploaded_icons"><img src="<?php echo $icon['image_40']; ?>"  defaulticons="0"></div>
        <?php
        }
        }
        }
        ...
        margin-top: -16px;
        margin-left: -40px;
        ">App Icon </h2><div class="clear"></div><div class="uploaded_icons"><img class="selected" src="<?php echo $icon['image_40']; ?>"></div><div class="clear"></div>
        <?php } ?>
     ...
     if($II == 0)
        ...
        ?>
        <div class="uploaded_icons"><img class="selected" defaulticons="1" src="<?php echo $self_icon['image_40']; ?>" data-size="<?php echo $size; ?>"></div>
        <?php } else { ?>
        <div class="uploaded_icons"><img class="selected" src="<?php echo $self_icon['image_40']; ?>" defaulticons="1" data-size="<?php echo $size; ?>"></div>
        <?php } ?>
        <div class="clear"></div>
