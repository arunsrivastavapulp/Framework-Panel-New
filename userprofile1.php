        ...
        <div class="letuscall_popup">
            ...
            <div class="letuscall_popup_body">
                <div class="letuscall_form">
                    ...
                    <input type="submit" id="withoutotp" value="Update Mobile Number">
                    <div class="clear"></div>
                        ...
                        <div class="edit_account_form_right">
                            ...
                            <div class="edit_inputs">
                                <div class="edit_inputs_left">
                                    ...
                                    <input type="tel" maxlength="16" minlength="5" id="mobile" name='mobile' class="required" onKeyPress="return isNumber(event)" value="<?php echo $user['mobile']; ?>"  class='formMobile'>
                                    <?php
